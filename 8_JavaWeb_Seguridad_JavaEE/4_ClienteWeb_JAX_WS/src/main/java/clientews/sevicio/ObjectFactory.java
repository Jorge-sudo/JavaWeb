 ...
 * generated in the clientews.sevicio package. 
...
public class ObjectFactory {
    ...
    private final static QName _ListarPersonas_QNAME = new QName("http://servicio/", "listarPersonas");
    private final static QName _ListarPersonasResponse_QNAME = new QName("http://servicio/", "listarPersonasResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: clientews.sevicio
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://servicio/", name = "listarPersonas")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://servicio/", name = "listarPersonasResponse")
