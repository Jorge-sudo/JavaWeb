...
@Results({//Resultados posibles si se logra acceder al sistemas entomnces se ejecutara bienvenido.jsp si no login.jsp
...
public class ValidarUsuarioAction extends ActionSupport {
    ...
    @Action("validarUsuario")//Nombre de la action 
    @Override
