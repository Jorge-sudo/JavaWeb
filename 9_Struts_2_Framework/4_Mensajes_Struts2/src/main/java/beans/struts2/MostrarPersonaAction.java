...
public class MostrarPersonaAction extends ActionSupport {
    ...
    /*Para poder acceder alas propiedades de el archivo .propierties aqui definiremos el get para que desde el JSP 
    se pueda acceder a las propiedades definidas */
