...
public class Asignacion implements Serializable {
    ...
    //Esta es la relacion con la tabla de alumno 
    @JoinColumn(name="id_alumno",referencedColumnName = "id_alumno")
    @ManyToOne//muchos=asignaciones a uno=alumno 
    private Alumno alumno;
    
    //No es necesario pero si son diferentes los nombres de la columnas entonces si es necesario 
    @JoinColumn(name="id_curso",referencedColumnName = "id_curso")
    @ManyToOne//muchos=asignaciones a uno=curso
    private Curso curso;
